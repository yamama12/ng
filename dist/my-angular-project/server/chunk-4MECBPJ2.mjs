...
import{B as y,C as P,F as S,J as Z,M as F,a as d,b as r,c,d as v,e as m,f as u,g as C,h as f,i as n,j as e,k as t,l as M,m as p,n as _,o as b,p as w,q as a,r as x,w as k,z as O}from"./chunk-BX344D43.mjs";var L=(o,l)=>l.title,T=()=>({title:"Explore the Docs",link:"https://angular.dev"}),V=()=>({title:"Learn with Tutorials",link:"https://angular.dev/tutorials"}),D=()=>({title:"CLI Docs",link:"https://angular.dev/tools/cli"}),I=()=>({title:"Angular Language Service",link:"https://angular.dev/tools/language-service"}),U=()=>({title:`Angular\r
  ...
  }`]})};var A=[];var H={providers:[k({eventCoalescing:!0}),F(A),P()]};var G={providers:[S()]},E=O(H,G);var B=()=>y(g,E),p1=B;export{p1 as a};
